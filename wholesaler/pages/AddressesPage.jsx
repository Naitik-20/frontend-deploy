      ...
      <div className="address-layout">
        <form className="dashboard-form address-form" onSubmit={onSaveAddress}>
          ...
          <div className="form-grid">
            <label>
              First Name
              <input name="firstName" value={addressForm.firstName} onChange={onAddressChange} />
            </label>
            <label>
              Last Name
              <input name="lastName" value={addressForm.lastName} onChange={onAddressChange} />
            </label>
          </div>
          <div className="form-grid">
            <label>
              Phone
              <input name="phone" value={addressForm.phone} onChange={onAddressChange} />
            </label>
            <label>
              Country
              <input name="country" value={addressForm.country} onChange={onAddressChange} />
            </label>
          </div>
          <label>
            Address
          ...
          <div className="form-grid">
            ...
            <label>
              State / Region
              <input name="region" value={addressForm.region} onChange={onAddressChange} />
            </label>
          </div>
          <label>
            Zip / Pincode
            <input name="zip" value={addressForm.zip} onChange={onAddressChange} />
          </label>
